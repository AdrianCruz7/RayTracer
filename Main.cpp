...
{
    //light
    scene.AddObject(std::make_unique<Sphere>(glm::vec3{ 5, 5.0f, 3 }, 0.5f, std::make_unique<Emissive>(color3{ 40, 40, 40 })));
    ...
    scene.AddObject(std::make_unique<Sphere>(glm::vec3{ -1.25f, 0.5f, -1 }, 0.5f, std::make_unique<Dielectric>(color3{ 1, 1, 1 }, 0.1f)));
